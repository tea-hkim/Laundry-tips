...
struct DetergentInfoDetail2: View {
    var body: some View {
...
struct DetergentInfoDetail2_Previews: PreviewProvider {
    static var previews: some View {
        DetergentInfoDetail2()
    }
}
