...
struct DetergentInfoDetail4: View {
    var body: some View {
...
struct DetergentInfoDetail4_Previews: PreviewProvider {
    static var previews: some View {
        DetergentInfoDetail4()
    }
}
