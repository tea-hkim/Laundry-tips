...
struct WashingMethodDetail5: View {
    var body: some View {
        ScrollView(showsIndicators: false) {
            VStack {
                Image("WashingMethod5")
                    .resizable()
...
struct WashingMethodDetail5_Previews: PreviewProvider {
    static var previews: some View {
        WashingMethodDetail5()
    }
}
