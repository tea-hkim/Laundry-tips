...
struct WashingMethodDetail2: View {
    var body: some View {
        ScrollView(showsIndicators: false) {
            VStack {
                Image("WashingMethod2")
                    .resizable()
...
struct WashingMethodDetail2_Previews: PreviewProvider {
    static var previews: some View {
        WashingMethodDetail2()
    }
}
