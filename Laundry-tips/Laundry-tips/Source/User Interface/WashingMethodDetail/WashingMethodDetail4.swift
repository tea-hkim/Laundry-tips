...
struct WashingMethodDetail4: View {
    var body: some View {
        ScrollView(showsIndicators: false) {
            VStack {
                Image("WashingMethod4")
                    .resizable()
...
struct WashingMethodDetail4_Previews: PreviewProvider {
    static var previews: some View {
        WashingMethodDetail4()
    }
}
