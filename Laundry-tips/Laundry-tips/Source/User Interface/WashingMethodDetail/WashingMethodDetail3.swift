...
struct WashingMethodDetail3: View {
    var body: some View {
        ScrollView(showsIndicators: false) {
            VStack {
                Image("WashingMethod3")
                    .resizable()
...
struct WashingMethodDetail3_Previews: PreviewProvider {
    static var previews: some View {
        WashingMethodDetail3()
    }
}
